...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-2.5 bg-white dark:bg-[#1A1A1A] text-zinc-400 dark:text-zinc-500 hover:text-[#2DBFAD] rounded-xl shadow-sm border border-zinc-50 dark:border-zinc-800 transition-all active:scale-95"
